...
type DeepMutableAux<T> = 
  T extends object
  ? T extends Function
    ? T
    : {-readonly [K in keyof T]: DeepMutableAux<T[K]>}
  : T;

type DeepMutable<T extends object>= DeepMutableAux<T>;

//ONLINE SOLUTION
//Lesson: T extends Record type allows primitive types
